...
De top-begrippen worden gevorm door de NBility-bedrijfsobjecten. Dit zorgt voor duidelijkheid over eigenaarschap voor wat betreft de definities, de modellen en de data. Elk nieuw begrip moet onder een van deze top-begrippen worden gehangen, direct of indirect.

We nemen een begrip alleen op als deze binnen de context van de netbeheerder een unieke betekenis heeft, zoals `aansluiting`. Begrippen zoals `postcode` nemen we niet op.
...
1. definities uit regelgeving krijgen voorrang
...
De naam van een begrip volgt de Nederlandse spellingsregels en begint niet met een hoofdletter, tenzij dat de juiste spelling van het woord is. Voor de URI's gebruiken we kebab-case met kleine letters.
