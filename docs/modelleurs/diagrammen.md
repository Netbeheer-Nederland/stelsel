...
Voor het tekenen van conceptuele informatiemodellen gebruiken we [draw.io](https://www.drawio.com/). Deze tool is vrij beschikbaar, gemakkelijk in gebruik, en werkt goed samen met GitHub. Daarnaast stelt deze tool ons in staat modellen te maken die visuele rust en zorgvuldigheid uitstralen, wat essentieel is voor gedeelde betekenis in sectorbrede context.
...
![Aansluitingenregister]({{ site.baseurl }}/registers/aansluitingenregister/1.3/aansluitingenregister.drawio.svg)

Voor de onderstaande stijlkeuzen geldt steeds hetzelfde achterliggende principe: visuele rust en duidelijkheid zijn noodzakelijk om betekenis te laten landen bij een breed publiek.
